...
export const CalendarInterface: React.FC = () => {
  return (
    <div className="max-w-md mx-auto mt-16 bg-white rounded-xl shadow-xl p-4 relative">
      <div className="space-y-3">
        <div className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded">
          ...
          <div>
            ...
            <div className="text-sm text-gray-500">10:30 | Today</div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded">
          ...
          <div>
            <div className="font-medium">Meeting with Elon</div>
            <div className="text-sm text-gray-500">14:00 | Remote</div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded">
          ...
          <div>
            <div className="font-medium">Social Media Integrations</div>
            <div className="flex gap-2 mt-1">
              ...
              <div className="w-6 h-6 bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-500 rounded flex items-center justify-center">
                <svg className="w-4 h-4 text-white" viewBox="0 0 24 24" fill="currentColor">
